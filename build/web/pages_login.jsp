...
<html>
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>Project Invoker - Login Page</title>
                        ...
                        <div class="row mb15 table-layout">
                            ...
                            <div class="col-xs-6 text-right va-b pr5">
                                <div class="login-links">
                                    <a href="pages_login.jsp" class="active" title="Sign In">Sign In</a>
                                    <span class="text-white"> | </span>
                                    <a href="pages_register.jsp" class="" title="Register">Register</a>
                                </div>
                        ...
                        <div class="panel panel-info mt10 br-n">
                            ...
                            <jsp:useBean id="user" scope="request" class="beans.User"></jsp:useBean>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-7 pr30">
                                                ...
                                                <div class="section">
                                                    ...
                                                    <label for="username" class="field prepend-icon">
                                                        <input type="text" name="user" id="username" class="gui-input" placeholder="Enter username" value="<jsp:getProperty name="user" property="user"/>">
                                            ...
                                            <div class="section">
                                                ...
                                                <label for="password" class="field prepend-icon">
                                                    <input type="password" name="pwd" id="password" class="gui-input" placeholder="Enter password" value="<jsp:getProperty name="user" property="pwd"/>">
                                ...
                                <div class="panel-footer clearfix p10 ph15">
                                    <input type="submit" value="Login" class="button btn-primary mr10 pull-right">
